...
class UserTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_user = User('1','Abigail','abigail@gmail.com','abcdefg','Python was created by Guido van Rossum, and released in 1991.','I did not know that')
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.username,"Abigail")
        self.assertEqual(self.new_user.email,"abigail@gmail.com")
